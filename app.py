...
PROJECTS = {
    'car-dealership': {
        ...
        'full_description': 'Our final year project is a fully functional, interactive web portal designed for a car dealership. It was built using the Python Flask framework for the backend logic and routing. For data persistence, it utilizes SQLAlchemy to manage a database of vehicle inventory, customer inquiries, and sales records. The entire application was deployed on Render.com to demonstrate a complete deployment cycle.',
